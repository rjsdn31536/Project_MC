...
def insertData(user_email,user_pnum,user_address,user_age,user_sex,user_family):
    # DB 연동 - 연결
    conn = pymysql.connect(host='localhost',port=3306,user='root',passwd='1234', db='project_mc',charset='utf8', cursorclass=pymysql.cursors.DictCursor)
    cursor = conn.cursor()
...
def member_update():
    ...
    conn = pymysql.connect(host='localhost',port=3306,user='root',passwd='1234',
             db='project_mc',charset='utf8', cursorclass=pymysql.cursors.DictCursor)
    cursor = conn.cursor()
